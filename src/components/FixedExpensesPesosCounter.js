...
const FixedExpensesPesosCounter = () => {
  ...
  return (
    <Card 
      ...
      className="custom-fixed-expenses-card-pesos"
      onMouseEnter={(e) => {
        ...
        <div style={{
          ...
          <div>
            <h3 style={{
              ...
              {t('userProfile.dashboard.card.fixedExpenses.ars')}
            </h3>
            <p style={{
              color: '#94a3b8',
              fontSize: '12px',
...
style.textContent = `
  .custom-fixed-expenses-card-pesos .ant-card {
    background: transparent !important;
  }
  .custom-fixed-expenses-card-pesos .ant-card-body {
    background: transparent !important;
  }
  .custom-fixed-expenses-card-pesos .ant-card-content {
    background: transparent !important;
  }
`;
