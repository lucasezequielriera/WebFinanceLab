...
const UnifiedExpensesDollarsCounter = () => {
  ...
  return (
    <Card 
      ...
      className="custom-unified-expenses-card"
      onMouseEnter={(e) => {
...
style.textContent = `
  .custom-unified-expenses-card .ant-card {
    background: transparent !important;
  }
  .custom-unified-expenses-card .ant-card-body {
    background: transparent !important;
  }
  .custom-unified-expenses-card .ant-card-content {
    background: transparent !important;
  }
`;
document.head.appendChild(style);

export default UnifiedExpensesDollarsCounter;
